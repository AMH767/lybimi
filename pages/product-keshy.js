        ...
        <div className="container">
          ...
          <div className="col-lg-6">
              <div className="contact-right-image wow fadeInRight delay-0-4s">
                <img
                  src="https://raw.githubusercontent.com/AMH767/image/main/oreshki/keshyjareni111.png"
                  alt="Contact From"
                />
                {/* <img
                  className="bg"
            ...
            <div className="col-xl-5 col-lg-6">
              <div className="product-details-content mb-30 wow fadeInRight delay-0-2s">
                ...
                <p>
                Кешью - вкусный орех с множеством полезных свойств.
                Он богат витаминами, минералами и антиоксидантами. 
                Уникальный вкус сочетает сладость и легкую горчинку. 
                Хорош для кожи, иммунной системы и сердца.
                </p>
          ...
          <Tab.Container defaultActiveKey={"information"}>
            ...
            <Tab.Content className="tab-content wow fadeInUp delay-0-2s">
              ...
              <Tab.Pane className="tab-pane" eventKey="information">
                <p>
                Кешью - это ореховое дерево, плоды которого широко используются в кулинарии для добавления текстуры и богатого орехового вкуса в различные блюда, а также для приготовления молока и соусов.
                Вот 5 вариантов, где кешью выступает великолепным дополнением:
                </p>
                <ul className="list-style-one mt-25 mb-25">
                  <li>Карри с кешью: добавьте кешью в карри для добавления текстуры и богатого орехового вкуса. Особенно вкусно сочетается с кокосовым молоком и карри-пастой.</li>
                  <li>Салат с кешью: добавьте кешью к свежему салату для придания ему хрустящей текстуры и богатого орехового вкуса. Сочетается отлично с оливковым маслом, лимонным соком и свежими травами.</li>
                  <li>Тайский ореховый соус: используйте кешью, чтобы приготовить тайский ореховый соус, который прекрасно подходит к греческим лапшам или в качестве соуса для маринования мяса.</li>
                  <li>Кешью-молоко: используйте кешью для приготовления растительного молока, которое можно добавить в кофе, завтраки или приготовление коктейлей.</li>
                  <li>Карри с овощами и кешью: приготовьте овощное карри с добавлением кешью, чтобы получить более насыщенный вкус и текстуру. Отлично сочетается с басмати-рисом и свежими травами.</li>
