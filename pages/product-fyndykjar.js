        ...
        <div className="container">
          ...
          <div className="col-lg-6">
              <div className="contact-right-image wow fadeInRight delay-0-4s">
                <img
                  src="https://raw.githubusercontent.com/AMH767/image/main/oreshki/fyndykjareni111.png"
                  alt="Contact From"
                />
                {/* <img
                  className="bg"
            ...
            <div className="col-xl-5 col-lg-6">
              <div className="product-details-content mb-30 wow fadeInRight delay-0-2s">
                ...
                <div className="section-title mb-20">
                  <h2>Фундук Жаренный</h2>
                </div>
                <p>
                Фундук жареный - это деликатесный орех с неповторимым вкусом и хрустящей текстурой.
                 Он отличается от обычного фундука своим специфическим обжаренным вкусом, который придает ему особенную привлекательность.
                  Фундук жареный богат полезными свойствами: он содержит белок, жиры, кожуру.
                   Благодаря высокому содержанию витаминов, минералов и антиоксидантов, фундук не только насыщает организм энергией,
                    но и способствует поддержанию здоровья. Уникальность его вкуса заключается в сочетании приятной сладости с легкой горчинкой.
                     Фундук жареный является великолепным перекусом и украшением для различных блюд.
                </p>
          ...
          <Tab.Container defaultActiveKey={"information"}>
            ...
            <Tab.Content className="tab-content wow fadeInUp delay-0-2s">
              <Tab.Pane className="tab-pane" eventKey="information">
                <p>
                Фундук жареный - это ореховое ядро фундука, предварительно обжаренное, которое прекрасно используется в кулинарии для добавления хрустящей текстуры и ароматного вкуса в различные блюда.
                Вот 5 вариантов, где кешью выступает великолепным дополнением:
                </p>
                <ul className="list-style-one mt-25 mb-25">
                  <li>Фундук жареный в салате: Добавьте нежные листья салата, свежие овощи и кусочки жареного фундука в салатную миску. Подача с нежным оливковым маслом или соусом на основе горчицы будет идеальным выбором.</li>
                  <li>Фундук жареный в выпечке: Используйте жареный фундук в мучных изделиях, таких как пироги, кексы или булочки. Он придаст им более насыщенный вкус и хрустящую текстуру. Попробуйте добавить их в шоколадные печенья для того, чтобы создать сочетание сладости и хруста.</li>
                  <li>Фундук жареный в горячем блюде: Добавьте жареный фундук в вегетарианские блюда, такие как овощные тушенки или рагу. Это добавит не только текстуру и хруст, но и обогатит блюдо витаминами и минералами.</li>
                  <li>Фундук жареный в десерте: Используйте жареный фундук в десертах, как добавку к мороженому, пудингу или тартам. Он придаст дополнительный хруст и неповторимый вкус, делая сладости более интересными и аппетитными.</li>
                  <li>Фундук жареный в пряных блюдах: Попробуйте добавить жареный фундук в пряные блюда, такие как карри или тагин. Его хрустящая текстура и нежный вкус прекрасно сочетаются с пряными ароматами, придавая блюду новую изюминку.</li>
